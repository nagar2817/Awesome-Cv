...
export const experienceData = [
    ...
    },
    {
      ...
      bullets: [
        'Worked on the frontend of the e-commerce platform using Angular.',
        'Optimized website performance to reduce loading times.',
        'Implemented A/B tests to improve conversion rates.',
      ],
    },
...
export const courseWorkData = [
    "Data Structures and Algorithms" ,"Introduction to Machine Learning", "Introduction To Computer Science","Linear Algebra", "Scientific Computations", "Calculus and Differential Equations."
];
